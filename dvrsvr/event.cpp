...
#ifdef APP_PWZ8			
	else if( keycode==(int)VK_RECON ) {				// rec force on
		rec_pwii_force_rec( 0, 1);
		rec_pwii_force_rec( 1, 1);
	}	
	else if( keycode==(int)VK_RECOFF ) {			// rec force off
		rec_pwii_force_rec( 0, 0);
		rec_pwii_force_rec( 1, 0);
	}		
#endif	
