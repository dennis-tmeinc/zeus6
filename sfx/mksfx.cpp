...
int archive_file(FILE* archive, char* ifilename, char* ofilename)
{
	...
	l = fhd.namesize;
	if (filestat.st_size < 100 || strcmp(ofilename + l - 3, ".gz") == 0 || strcmp(ofilename + l - 4, ".gif") == 0 || strcmp(ofilename + l - 4, ".png") == 0 || strcmp(ofilename + l - 4, ".jpg") == 0) {
		nocompress = 1;
	} else {
		nocompress = 0;
	}
...
int main(int argc, char* argv[])
{
	...
	if (argc > 1) {
		if (strcmp(argv[1], "-?") == 0 || strcmp(argv[1], "?") == 0 || strcmp(argv[1], "-h") == 0 || strcmp(argv[1], "-help") == 0) {
