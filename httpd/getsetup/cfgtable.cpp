...
cfg_table bodycamera_table[] = {
    // enable
    {NULL, "enable", "bcam_enable", 3},
    // bodycam ip address
    {NULL, "ip", "bcam_ip", 0},
    // to trigger dvr by bodycam
    {NULL, "bodycam_trigger", "bcam_trigger", 3},
    // trigger by dvr
    {NULL, "dvr_trigger", "bcam_dvrtrigger", 3},
    {NULL, NULL, NULL, 0}
};

cfg_table network_table[] = {
    // eth_ip
    {"network", "eth_ip", "eth_ip", 0},
    // eth_mask
    {"network", "eth_mask", "eth_mask", 0},
    // dhcp client on eth0
    {"network", "eth_dhcp", "eth_dhcp", 3},
    // wifi ip
    {"network", "wifi_ip", "wifi_ip", 0},
    // wifi_mask
    {"network", "wifi_mask", "wifi_mask", 0},
    ...
    // ap key
    {"network", "ap_key", "ap_key", 0},
    // ap channel
    {"network", "ap_channel", "ap_channel", 1},
    // gateway
    ...
    //        7 : WPA2 Personal AES
    {"network", "wifi_enc", "wifi_enc", 1},
    // wifi_essid
    {"network", "wifi_essid", "wifi_essid", 0},
    // wifi_key
    {"network", "wifi_key", "wifi_key", 0},
    // smartserver ip
    {"network", "smartserver", "smartserver", 0},
    // internet access
    {"system", "nointernetaccess", "internetaccess", 4},
    // internet key
    {"system", "internetkey", "internetkey", 0},
    {NULL, NULL, NULL, 0}
};
